...
export function AdvisorChat({ analysis, context, phase, compact, onWorkspace, onEvidence, onNews, onRefresh }: {
  analysis: Analysis; context?: MarketContext; phase: string; compact?: boolean; onWorkspace: () => void; onEvidence: (e: Evidence) => void; onNews: (id: string,name: string) => void; onRefresh: () => void;
}) {
