...
export function CustomerGraph({ analysis, selected, overview, onOverview, onSelect, onEvidence, onBrief, fundStatus, onRefreshFund, context, contextFocus, nodeFocus }: {
  ...
  fundStatus: Record<string, FundLookupState>; onRefreshFund: (isin: string) => void; context?: MarketContext; contextFocus?: string; nodeFocus?: string;
}) {
