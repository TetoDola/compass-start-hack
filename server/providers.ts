...
export interface ProviderConfig { FMP_API_KEY?: string; OPENBB_BASE_URL?: string; OPENBB_NEWS_PROVIDER?: string; OPENBB_SYMBOLS?: string; OPENAI_API_KEY?: string; OPENAI_MODEL?: string }
